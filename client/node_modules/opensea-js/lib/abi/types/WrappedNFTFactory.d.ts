...
export interface WrappedNFTFactory extends BaseContract {
    constructor(jsonInterface: any[], address?: string, options?: ContractOptions): WrappedNFTFactory;
    clone(): WrappedNFTFactory;
    methods: {
