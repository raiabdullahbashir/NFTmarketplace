import { Remap } from '@react-spring/shared'

export * from '@react-spring/shared/types/common'
 ...
 */
export type ForwardProps<T extends object> = Remap<
  Pick<T, Exclude<keyof T, keyof ReservedProps>>
>
